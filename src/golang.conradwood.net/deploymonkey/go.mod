...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.3625
	golang.conradwood.net/apis/common v1.1.3630
	golang.conradwood.net/apis/deploymonkey v1.1.3625
	golang.conradwood.net/apis/grafanadata v1.1.3625
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3630 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.3630 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3630 // indirect
