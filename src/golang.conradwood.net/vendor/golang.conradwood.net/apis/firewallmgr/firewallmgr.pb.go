...
type FirewallMgrClient interface {
	...
	// request re-sync
	Resync(ctx context.Context, in *common.Void, opts ...grpc.CallOption) (*common.Void, error)
}
...
func (c *firewallMgrClient) Resync(ctx context.Context, in *common.Void, opts ...grpc.CallOption) (*common.Void, error) {
	out := new(common.Void)
	err := grpc.Invoke(ctx, "/firewallmgr.FirewallMgr/Resync", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FirewallMgrServer interface {
	...
	// request re-sync
	Resync(context.Context, *common.Void) (*common.Void, error)
}
...
func _FirewallMgr_Resync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(common.Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FirewallMgrServer).Resync(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/firewallmgr.FirewallMgr/Resync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FirewallMgrServer).Resync(ctx, req.(*common.Void))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FirewallMgr_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Resync",
			Handler:    _FirewallMgr_Resync_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	0x72, 0x46, 0x0b, 0x98, 0xb8, 0xb8, 0xdd, 0xa0, 0xe2, 0xbe, 0xe9, 0x45, 0x42, 0x6a, 0x5c, 0xac,
	...
	0xa9, 0x29, 0x42, 0x28, 0x72, 0x52, 0xd8, 0xb4, 0x0b, 0xa9, 0x70, 0xb1, 0x05, 0xa5, 0x16, 0x57,
	0xe6, 0x25, 0xa3, 0x29, 0x46, 0xe1, 0x39, 0x29, 0x72, 0xc9, 0xe7, 0xa5, 0x96, 0x20, 0x47, 0x0a,
	0x28, 0x42, 0x90, 0xcd, 0x4b, 0x62, 0x03, 0xc7, 0x87, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xb6,
	0xf0, 0xcc, 0x20, 0x08, 0x02, 0x00, 0x00,
}
