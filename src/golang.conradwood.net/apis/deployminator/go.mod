...
require (
	...
	golang.conradwood.net/apis/common v1.1.3598
	golang.conradwood.net/apis/deploymonkey v1.1.3576
...
require (
	...
	golang.yacloud.eu/apis/session v1.1.3598 // indirect
