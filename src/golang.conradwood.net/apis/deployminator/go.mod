...
require (
	...
	golang.conradwood.net/apis/common v1.1.3528
	golang.conradwood.net/apis/deploymonkey v1.1.3376
...
require (
	...
	golang.yacloud.eu/apis/session v1.1.3528 // indirect
