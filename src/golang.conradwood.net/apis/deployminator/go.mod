module golang.conradwood.net/apis/deployminator
...
require (
	...
	golang.conradwood.net/apis/common v1.1.3905
	golang.conradwood.net/apis/deploymonkey v1.1.3794
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.3905 // indirect
	golang.conradwood.net/apis/autodeployer v1.1.3625 // indirect
	golang.conradwood.net/apis/framework v1.1.3625 // indirect
	golang.conradwood.net/apis/goeasyops v1.1.3905 // indirect
	golang.conradwood.net/apis/grafanadata v1.1.3794 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.3905 // indirect
