...
import fmt "fmt"
import math "math"
import commondeploy "golang.conradwood.net/apis/commondeploy"
...
type ApplicationDefinition struct {
	...
	Container    *commondeploy.ContainerDef `protobuf:"bytes,22,opt,name=Container" json:"Container,omitempty"`
}
...
func (m *ApplicationDefinition) GetContainer() *commondeploy.ContainerDef {
	if m != nil {
		return m.Container
	}
	return nil
...
func (*DelVersionRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{44} }
...
var fileDescriptor0 = []byte{
	...
	,
}
