...
require (
	golang.conradwood.net/apis/autodeployer v1.1.2878
	golang.conradwood.net/apis/common v1.1.2935
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2935 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2935 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2935 // indirect
